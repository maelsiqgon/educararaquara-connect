...
const Footer = () => {
  ...
  return (
    <footer className="bg-education-dark text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-education-primary font-bold text-xl">
                E
              </div>
              <div>
                <h3 className="text-lg font-bold">EducAraraquara</h3>
                <p className="text-xs text-gray-300">Portal Educacional</p>
              </div>
            </div>
          ...
          <div>
            <h3 className="font-bold mb-4 text-education-accent">Links Rápidos</h3>
          ...
          <div>
            <h3 className="font-bold mb-4 text-education-accent">Acesso</h3>
            <ul className="space-y-2 text-sm">
          ...
          <div>
            <h3 className="font-bold mb-4 text-education-accent">Contato</h3>
            <ul className="space-y-2 text-sm">
            ...
            <div className="mt-4 flex space-x-3">
              <a href="#" className="hover:text-education-accent" aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
              </a>
              <a href="#" className="hover:text-education-accent" aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"></line></svg>
              </a>
              <a href="#" className="hover:text-education-accent" aria-label="Twitter">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path></svg>
              </a>
              <a href="#" className="hover:text-education-accent" aria-label="YouTube">
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-sm text-gray-400 flex flex-col md:flex-row justify-between items-center">
          <div>© {currentYear} Secretaria Municipal de Educação de Araraquara. Todos os direitos reservados.</div>
